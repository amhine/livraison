...
INSERT INTO delivery (name_client, address, latitude, longitude, poids, volume, status, tour_id) VALUES
  ('Alice Martin', '12 Rue des Fleurs, Paris', 48.8606, 2.3376, 2.5, 0.02, 'en_attente', 1),
  ('Bob Dupont', '5 Boulevard Voltaire, Paris', 48.8570, 2.3709, 7.0, 0.05, 'en_cours', 1),
  ('Carla Leroy', '3 Rue Victor Hugo, Paris', 48.8530, 2.3499, 15.0, 0.10, 'livree', 1),
  ('Denis Morel', '20 Rue de la Republique, Lyon', 45.7630, 4.8350, 3.0, 0.03, 'en_attente', 2),
  ('Emma Blanc', '8 Quai Saint-Antoine, Lyon', 45.7645, 4.8350, 1.2, 0.01, 'en_cours', 2);